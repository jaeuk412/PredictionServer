# -*- coding: utf-8 -*-
# 과거 데이터 크롤링. crawling_main('naju',2019)
...
def crawling_temp_data(area, target_year, month_list):
	...
	f = open(folder_prediction_path + "data/temperature/%s_temp_%d" % (area, target_year), 'w')
...
def crawling_main(area, target_year):
	month_list = []
	...
	crawling_temp_data(area, target_year, month_list)

# crawling_main('naju',2018)