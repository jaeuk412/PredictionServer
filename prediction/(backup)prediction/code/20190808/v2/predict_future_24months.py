...
def conduct_prediction(area, start_year, start_month, month_range):
	...
	daily_output_file = './result/future_%s_%d_%d_%d_daily'%(area, start_year, start_month, month_range)
	...
	monthly_output_file = './result/future_%s_%d_%d_%d_monthly'%(area, start_year, start_month, month_range)
